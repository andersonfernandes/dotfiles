...
_G.packer_plugins = {
  ...
  ["highlight-undo.nvim"] = {
    ...
    loaded = true,
    path = "/home/anderson/.local/share/nvim/site/pack/packer/start/highlight-undo.nvim",
  ...
  ["nui.nvim"] = {
    loaded = true,
    path = "/home/anderson/.local/share/nvim/site/pack/packer/start/nui.nvim",
  ...
  ["tokyonight.nvim"] = {
    loaded = true,
    path = "/home/anderson/.local/share/nvim/site/pack/packer/start/tokyonight.nvim",
